...
def exportPattern(texture):
    ...
    if pat.tex_pattern_type == 'emulator':
        ...
        # Edited by ACHQ on Feb. 2: Not sure why this is here, but if I leave it
        # I am not able to use multiple .incs from the meshes, as they have the same function defined
        #texStrg+="#declare f%s=\n"%PATname
...
def write_pov(filename, scene=None, obj=None, objname="default"):
    import mathutils
    #file = filename
...
#    objectNames = {}
    ...
    def exportMeshes(scene, ob, obname):
        obmats2data = {}
...
#############################################
        ...
        # We create .inc files, so no need of adding the object references
    ...
    exportMeshes(scene, obj, objname)
